...
def draw_venn(set_a, set_b, operation):
    """Draw a Venn diagram based on the given sets and operation."""
    if operation == "union":
        union_result = union(set_a, set_b)
        items = [
            sorted(difference(set_a, set_b)),
            sorted(difference(set_b, set_a)),
            sorted(intersection(set_a, set_b)),
        ]
        ...
        diff_A_B = difference(set_a, set_b)
        diff_B_A = difference(set_b, set_a)
        intersection_result = intersection(set_a, set_b)
        ...
        plt.title("Complement of Sets A  (U - A)")
        # plt.text(
